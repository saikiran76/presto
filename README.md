...
[Velox](https://github.com/facebookincubator/velox) is a C++ database library that provides reusable, extensible, and high-performance data processing components.
...
* In the SDKs section, ensure that a 1.8 JDK is selected (create one if none exists)
* In the Project section, ensure the Project language level is set to 8.0 as Presto makes use of several Java 8 language features

Presto comes with a sample configuration that should work out of the box for development. Use the following options to create a run configuration:
...
* Use classpath of the module: `presto-main`
...
The Presto Web UI is composed of several React components and is written in JSX and ES6. This source code is compiled and packaged into browser-compatible JavaScript, which is then checked into the Presto source code (in the `dist` folder). You must have [Node.js](https://nodejs.org/en/download/) and [Yarn](https://yarnpkg.com/en/) installed to execute these commands. To update this folder after making changes, simply run:
...
To iterate quickly, simply re-build the project in IntelliJ after the packaging is complete. Project resources will be hot-reloaded and changes will be reflected on browser refresh.
